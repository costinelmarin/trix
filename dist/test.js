...
testGroup("Attachment galleries", {
  ...
  test$3("inserting a gallery in a formatted block", expectDocument => {
    clickToolbarButton({
      attribute: "quote"
    }, () => {
      typeCharacters("abc", () => {
...
testGroup("Block formatting", {
  ...
  test$3("applying block attributes", done => {
    typeCharacters("abc", () => {
      clickToolbarButton({
        attribute: "quote"
      }, () => {
  ...
  test$3("breaking out of the middle of a block before newline", done => {
    // * = cursor
    //
    // ab
    // *
  ...
  test$3("adding bullet to heading block", done => {
    clickToolbarButton({
      attribute: "heading1"
    }, () => {
      clickToolbarButton({
  ...
  test$3("removing bullet from heading block", done => {
    clickToolbarButton({
      attribute: "bullet"
    }, () => {
      clickToolbarButton({
  ...
  test$3("breaking out of heading in list", expectDocument => {
    clickToolbarButton({
      attribute: "bullet"
    }, () => {
      clickToolbarButton({
  ...
  test$3("breaking out of middle of heading block", expectDocument => {
    clickToolbarButton({
      attribute: "heading1"
    }, () => {
      typeCharacters("abc", () => {
  ...
  test$3("inserting newline after single character header", expectDocument => {
    clickToolbarButton({
      attribute: "heading1"
    }, () => {
      typeCharacters("a", () => {
  ...
  test$3("code blocks preserve newlines", expectDocument => {
    typeCharacters("a\nb", () => {
      selectAll(() => {
        clickToolbarButton({
          attribute: "code"
  ...
  test$3("code blocks are not indentable", done => {
    clickToolbarButton({
      attribute: "code"
    }, () => {
      assert.notOk(isToolbarButtonActive({
  ...
  test$3("code blocks are terminal", done => {
    clickToolbarButton({
      attribute: "code"
    }, () => {
      assert.ok(isToolbarButtonDisabled({
  ...
  test$3("unindenting a code block inside a bullet", expectDocument => {
    clickToolbarButton({
      attribute: "bullet"
    }, () => {
      clickToolbarButton({
  ...
  test$3("indenting a heading inside a bullet", expectDocument => {
    clickToolbarButton({
      attribute: "bullet"
    }, () => {
      typeCharacters("a", () => {
  ...
  test$3("indenting a quote inside a bullet", expectDocument => {
    clickToolbarButton({
      attribute: "bullet"
    }, () => {
      clickToolbarButton({
  ...
  test$3("list indentation constraints consider the list type", expectDocument => {
    clickToolbarButton({
      attribute: "bullet"
    }, () => {
      typeCharacters("a\n\n", () => {
...
testGroup("View caching", {
  ...
  test$3("reparsing and rendering identical texts", done => {
    typeCharacters("a\nb\na", () => {
      moveCursor({
        direction: "left",
        times: 2
  ...
  test$3("reparsing and rendering identical blocks", done => {
    clickToolbarButton({
      attribute: "bullet"
    }, () => {
      typeCharacters("a\na", () => {
...
testGroup("Canceled input", testOptions$1, () => {
  test$3("ignoring canceled input events in capturing phase", expectDocument => {
    typeCharacters("a", () => {
  ...
  test$3("ignoring canceled input events at target", expectDocument => {
    typeCharacters("a", () => {
...
testGroup("Composition input", {
  ...
  test$3("composition input is serialized", expectDocument => {
    startComposition("´", () => {
      endComposition("é", () => {
  ...
  test$3("pressing after a canceled composition", expectDocument => {
    typeCharacters("ab", () => {
  ...
  test$3("composing formatted text", expectDocument => {
    typeCharacters("abc", () => {
      clickToolbarButton({
        attribute: "bold"
      }, () => {
  ...
  test$3("composing away from formatted text", expectDocument => {
    clickToolbarButton({
      attribute: "bold"
    }, () => {
      typeCharacters("abc", () => {
...
testGroup("Level 2 Input", testOptions, () => {
  ...
  test$1("insertLineBreak", expectDocument => {
    clickToolbarButton({
      attribute: "quote"
    }, () => {
      insertString("abc");
  ...
  test$1("insertParagraph", expectDocument => {
    clickToolbarButton({
      attribute: "quote"
    }, () => {
      insertString("abc");
...
testGroup("List formatting", {
  ...
  test$3("creating a new list item", done => {
    typeCharacters("a", () => {
      clickToolbarButton({
        attribute: "bullet"
      }, () => {
  ...
  test$3("breaking out of a list", expectDocument => {
    typeCharacters("a", () => {
      clickToolbarButton({
        attribute: "bullet"
      }, () => {
  ...
  test$3("pressing return at the beginning of a non-empty list item", expectDocument => {
    clickToolbarButton({
      attribute: "bullet"
    }, () => {
      typeCharacters("a\nb", () => {
  ...
  test$3("pressing tab increases nesting level, tab+shift decreases nesting level", expectDocument => {
    clickToolbarButton({
      attribute: "bullet"
    }, () => {
      typeCharacters("a", () => {
  ...
  test$3("pressing delete at the beginning of a non-empty nested list item", expectDocument => {
    clickToolbarButton({
      attribute: "bullet"
    }, () => {
      typeCharacters("a\n", () => {
  ...
  test$3("decreasing list item's level decreases its nested items level too", expectDocument => {
    clickToolbarButton({
      attribute: "bullet"
    }, () => {
      typeCharacters("a\n", () => {
...
testGroup("Pasting", {
  ...
  test$3("paste simple html", expectDocument => {
    typeCharacters("abc", () => {
      moveCursor("left", () => pasteContent("text/html", "&lt;", () => expectDocument("ab<c\n")));
    });
  });
  test$3("paste complex html", expectDocument => {
    typeCharacters("abc", () => {
      moveCursor("left", () => {
  ...
  test$3("paste html in expanded selection", expectDocument => {
    typeCharacters("abc", () => {
      moveCursor("left", () => {
        expandSelection({
          direction: "left",
  ...
  test$3("paste html with CRLF ", expectDocument => {
  ...
  test$3("paste URL", expectDocument => {
    typeCharacters("a", () => {
  ...
  test$3("paste URL with name", expectDocument => {
    const pasteData = {
  ...
  test$3("paste complex html into formatted block", done => {
    typeCharacters("abc", () => {
      clickToolbarButton({
        attribute: "quote"
      }, () => {
  ...
  test$3("paste list into list", done => {
    clickToolbarButton({
      attribute: "bullet"
    }, () => {
      typeCharacters("abc\n", () => {
  ...
  test$3("paste list into quote", done => {
    clickToolbarButton({
      attribute: "quote"
    }, () => {
      typeCharacters("abc", () => {
  ...
  test$3("paste list into quoted list", done => {
    clickToolbarButton({
      attribute: "quote"
    }, () => {
      clickToolbarButton({
  ...
  test$3("paste nested list into empty list item", done => {
    clickToolbarButton({
      attribute: "bullet"
    }, () => {
      typeCharacters("y\nzz", () => {
  ...
  test$3("paste nested list over list item contents", done => {
    clickToolbarButton({
      attribute: "bullet"
    }, () => {
      typeCharacters("y\nzz", () => {
  ...
  test$3("paste list into empty block before list", done => {
    clickToolbarButton({
      attribute: "bullet"
    }, () => {
      typeCharacters("c", () => {
  ...
  test$3("paste file", expectDocument => {
    typeCharacters("a", () => {
      pasteContent("Files", createFile$1(), () => expectDocument("a".concat(OBJECT_REPLACEMENT_CHARACTER, "\n")));
    });
  });
...
testGroup("Text formatting", {
  ...
  test$3("applying attributes to text", done => {
    typeCharacters("abc", () => {
      expandSelection("left", () => {
        clickToolbarButton({
          attribute: "bold"
  ...
  test$3("applying a link to text", done => {
    typeCharacters("abc", () => {
      moveCursor("left", () => {
        expandSelection("left", () => {
          clickToolbarButton({
  ...
  test$3("inserting a link", expectDocument => {
    typeCharacters("a", () => {
      clickToolbarButton({
        attribute: "href"
      }, () => {
  ...
  test$3("typing after a link", done => {
    typeCharacters("ab", () => {
      expandSelection({
        direction: "left",
        times: 2
  ...
  test$3("applying formatting and then typing", done => {
    typeCharacters("a", () => {
      clickToolbarButton({
        attribute: "bold"
      }, () => {
  ...
  test$3("applying formatting and then moving the cursor away", done => {
    typeCharacters("abc", () => {
      moveCursor("left", () => {
        assert.notOk(isToolbarButtonActive({
          attribute: "bold"
  ...
  test$3("editing formatted text", done => {
    clickToolbarButton({
      attribute: "bold"
    }, () => {
      typeCharacters("ab", () => {
...
testGroup("Undo/Redo", {
  ...
  test$3("formatting changes are batched by location range", done => {
    typeCharacters("abc", () => {
      const first = getDocument().copy();
      expandSelection("left", () => {
        clickToolbarButton({
